...
export function Toolbar({ squareCount, isExporting, onAddSquare, onAutoFill, onExport, onClear, onNewImage }: ToolbarProps) {
        ...
        <div className="flex gap-2">
          <div ref={dropdownRef} className="relative flex-1">
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-md border border-border-1 text-text-2 text-xs font-medium tracking-wide hover:border-amber-glow/20 hover:text-text-1 hover:bg-amber-dim transition-all duration-200"
